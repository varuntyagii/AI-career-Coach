...
export async function getIndustryInsights() {
  try {
    ...
    // Return special object if industry not set
    if (!user.industry) {
      return {
        requiresOnboarding: true,
        message: "Please complete your profile by setting your industry"
      };
    }
    ...
    // If insights exist but are outdated
    if (new Date() > user.industryInsight.nextUpdate) {
      const insights = await generateAIInsights(user.industry);
